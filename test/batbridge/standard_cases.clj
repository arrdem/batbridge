...
(deftest fib-test
  ...
  (fn [state]
    (and (= (c/get-register state 2) 610) ;; fib 15 with th (0,1) as the base case
         (c/halted? state)))              ;; the processor should have halted correctly
